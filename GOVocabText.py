# Name: GOVocabText.py
# Purpose: GO vocabulary class for processing deprecated Text files
#
# History
#
# 12/15/2005 lec
#	- TR 5677
#	- Splitting GOVocab.py into GOVocabText and GOVocabOBO
#	- Moved Stack class to GOStack.py
#
# 04/02/2003 lec
#	TR 4564
#
...
class GOVocabText(Vocab.Vocab):
    """
    #  Object representing the Gene Ontology vocabulary parsing in Text format
    """
	...
	# build this GOVocabText using the specified definitions file and dag file
