...
#
# Program: runOMIMLoad.sh
#
# Purpose:
#
# Main Wrapper Script for Downloading Ontology files and generating OMIM Terms
# 
# Usage:
#
#	runOMIMLoad.sh [load|noload] [full|incremental]
#
# History:
#
#	lec	03/25/2003
#	- use new Configuration and OMIM.config files
#
...
echo "****************************************************************************" >> $MAIL_FILE_NAME
echo "OMIM Load Program Completion Status: $OMIM_LOAD_ERROR_MSG"                    >> $MAIL_FILE_NAME
echo "****************************************************************************" >> $MAIL_FILE_NAME
